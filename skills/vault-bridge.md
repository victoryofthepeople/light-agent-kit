...
- The user asks about work whose source of truth lives outside the kit workspace.
...
5. Define when external source data beats kit memory.
...
Source hierarchy:
- If the kit and this source conflict, trust:
...
- If the external source has fresher operational data than the kit, say that and cite the file used.
