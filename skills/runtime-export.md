...
- The user wants to use Light Agent Kit context in another AI tool.
...
7. Show the export bundle and ask before placing it anywhere outside the Light Agent Kit workspace.
