...
> **This flow is archived.** The main product is the guided setup site in `site/`. For current instructions, read [EXPAND.md](../EXPAND.md) and [README.md](../README.md).

This is the old agent-led setup flow for Light Agent Kit.

It is written for the AI agent. The user used to paste this repo into Claude, ChatGPT, Codex, or another agent and say:
